...
* **D (recommended):** link:https://github.com/dev-centr/prohelp-cli[prohelp-cli] with link:https://opendlang.org/library/arsd.cli.html[arsd.cli] (or another D CLI router) — parsing and routing stay in the framework; help stays in Prohelp.
...
For new D command-line tools, prefer link:https://github.com/dev-centr/prohelp-cli[prohelp-cli] integrated with a CLI router such as link:https://opendlang.org/library/arsd.cli.html[arsd.cli]. See the prohelp-cli repository for how execution routing and progressive help cooperate.
...
2. You publicly disclose the existence of your derivative work and notify the original project (Parent Project) at link:https://github.com/dev-centr/prohelp[dev-centr/prohelp] within 30 days of release or deployment.
